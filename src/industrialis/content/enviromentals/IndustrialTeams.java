...
public class IndustrialTeams {
    public static Team technocrats;

    public static void load() {
        technocrats = newTeam(3, "technocrats", Color.valueOf("800000"));
    }

    //code taken from FOS, much love <3
    private static Team newTeam(int id, String name, Color color) {
        ...
        TextureRegion region = Core.atlas.find("industrialis-team-" + name);
